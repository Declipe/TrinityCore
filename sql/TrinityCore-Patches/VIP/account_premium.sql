...
INSERT INTO `auth3`.`rbac_permissions` (`id`, `name`) VALUES
(999, 'Command: vip');

INSERT INTO `auth3`.`rbac_linked_permissions` (`id`, `linkedId`) VALUES
(195, 999);

INSERT INTO `world3`.`command` (`name`, `permission`, `help`) VALUES
