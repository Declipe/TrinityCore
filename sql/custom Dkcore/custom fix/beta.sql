...
UPDATE `instance_template` SET `Script` = 'dk_instance_trial_of_the_champion' WHERE `map` = 650;


UPDATE `creature_template` SET `ScriptName` = 'dk_boss_warrior_toc5' WHERE `entry` = '35572';
UPDATE `creature_template` SET `ScriptName` = 'dk_boss_warrior_toc5' WHERE `entry` = '34705';
UPDATE `creature_template` SET `ScriptName` = 'dk_boss_shaman_toc5' WHERE `entry` = '34701';
UPDATE `creature_template` SET `ScriptName` = 'dk_boss_mage_toc5' WHERE `entry` = '34702';
UPDATE `creature_template` SET `ScriptName` = 'dk_boss_rouge_toc5' WHERE `entry` = '34703';
UPDATE `creature_template` SET `ScriptName` = 'dk_boss_mage_toc5' WHERE `entry` = '35569';
UPDATE `creature_template` SET `ScriptName` = 'dk_boss_hunter_toc5' WHERE `entry` = '35570';
UPDATE `creature_template` SET `ScriptName` = 'dk_boss_shaman_toc5' WHERE `entry` = '35571';
UPDATE `creature_template` SET `ScriptName` = 'dk_boss_rouge_toc5' WHERE `entry` = '35617';
UPDATE `creature_template` SET `ScriptName` = 'dk_boss_black_knight' WHERE `entry` = '35451';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_risen_ghoul' WHERE `entry` = '35545';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_risen_ghoul' WHERE `entry` = '35564';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_risen_ghoul' WHERE `entry` = '35590';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_black_knight_skeletal_gryphon' WHERE `entry` = '35491';
UPDATE `creature_template` SET `ScriptName` = 'dk_boss_paletress' WHERE `entry` = '34928';
UPDATE `creature_template` SET `ScriptName` = 'dk_boss_eadric' WHERE `entry` = '35119';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_argent_soldier' WHERE `entry` = '35305';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_argent_soldier' WHERE `entry` = '35307';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_argent_soldier' WHERE `entry` = '35309';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_announcer_toc5' WHERE `entry` = '35004';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_announcer_toc5' WHERE `entry` = '35005';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35326';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35327';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35328';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35329';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35330';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35331';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35332';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35314';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35323';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35634';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35644';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '36559';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '33217';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '33316';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '33317';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '33318';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '33319';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '33320';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '33321';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '33322';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '33323';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '33324';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35633';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35635';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35636';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35637';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35638';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35640';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35641';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '35768';
UPDATE `creature_template` SET `ScriptName` = 'dk_generic_vehicleAI_toc5' WHERE `entry` = '34658';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '34942';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35028';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35029';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35030';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35031';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35032';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35033';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35034';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35036';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35037';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35038';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35039';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35040';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35041';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35042';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35043';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35044';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35045';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35046';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35047';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35048';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35049';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35050';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35051';
UPDATE `creature_template` SET `ScriptName` = 'dk_npc_memory' WHERE `entry` = '35052';
...
DELETE FROM `spell_script_names` WHERE `ScriptName` IN (
'dk_spell_black_knight_army_of_the_dead',
'dk_spell_black_knight_deaths_push',
'dk_spell_black_knight_ghoul_explode',
'dk_spell_black_knight_obliterate',
'dk_spell_eadric_hammer_of_righteous',
'dk_spell_eadric_hammer_of_righteous_faceroller',
'dk_spell_paletress_reflective_shield',
'dk_spell_toc5_lightning_arrows',
'dk_spell_eadric_radiance',
'dk_spell_paletress_summon_memory',
'dk_spell_toc5_trample_aura');

INSERT INTO `spell_script_names` (`spell_id`, `ScriptName`) VALUES
(67761, 'dk_spell_black_knight_army_of_the_dead'),         -- The Black Knight's Army of the Dead
(67874, 'dk_spell_black_knight_army_of_the_dead'),         -- The Black Knight's Army of the Dead
(66797, 'dk_spell_black_knight_deaths_push'),              -- The Black Knight's Death's Push - cast on announcer
(67751, 'dk_spell_black_knight_ghoul_explode'),            -- The Black Knight's Ghoul Explode
(67725, 'dk_spell_black_knight_obliterate'),               -- The Black Knight's Obliterate
(67883, 'dk_spell_black_knight_obliterate'),               -- The Black Knight's Obliterate
(66867, 'dk_spell_eadric_hammer_of_righteous'),            -- Eadric' Hammer of the Righteous
(66905, 'dk_spell_eadric_hammer_of_righteous_faceroller'), -- Eadric' Hammer of the Righteous - cast by player
(66515, 'dk_spell_paletress_reflective_shield'),           -- Paletress' Reflective Shield
(66083, 'dk_spell_toc5_lightning_arrows'),                 -- Hunter Grand Champion's Lightning Arrows
(66862, 'dk_spell_eadric_radiance'),
(67681, 'dk_spell_eadric_radiance'),
(66545, 'dk_spell_paletress_summon_memory'),
(67868, 'dk_spell_toc5_trample_aura');                     -- Trial of the Champion vehicles' Trample aura
...
UPDATE `creature_template` SET `ScriptName`='dk_generic_vehicleAI_toc5' WHERE `entry` IN (@ARGENT_BATTLEWORG_GC,@ARGENT_WARHORSE_GC);
...
UPDATE `creature_template` SET `AIName`='',`ScriptName`='dk_generic_vehicleAI_toc5' WHERE `entry` IN (@ORC_CHAMP,@TROLL_CHAMP,@TAUREN_CHAMP,@BELF_CHAMP,@UNDEAD_CHAMP,@HUMAN_CHAMP,@DWARF_CHAMP,@DRAENEI_CHAMP,@GNOME_CHAMP,@NELF_CHAMP);
...
(11858, 11, 'dk_achievement_eadric_faceroller');
...
INSERT INTO `achievement_criteria_data` (`criteria_id`,`type`,`ScriptName`) VALUES
(@CRITERIA_WARRIOR,  11,'dk_achievement_victories_over_war_champion'),
(@CRITERIA_HUNTER,   11,'dk_achievement_victories_over_hun_champion'),
(@CRITERIA_MAGE,     11,'dk_achievement_victories_over_mag_champion'),
(@CRITERIA_ROGUE,    11,'dk_achievement_victories_over_rog_champion'),
(@CRITERIA_SHAMAN,   11,'dk_achievement_victories_over_sha_champion'),
(@CRITERIA_WARRIOR_H,11,'dk_achievement_victories_over_war_champion_h'),
(@CRITERIA_HUNTER_H, 11,'dk_achievement_victories_over_hun_champion_h'),
(@CRITERIA_MAGE_H,   11,'dk_achievement_victories_over_mag_champion_h'),
(@CRITERIA_ROGUE_H,  11,'dk_achievement_victories_over_rog_champion_h'),
(@CRITERIA_SHAMAN_H, 11,'dk_achievement_victories_over_sha_champion_h');
...
UPDATE `creature_template` SET `ScriptName`='dk_npc_fountain_of_light' WHERE `entry`=35311;
...
INSERT INTO `achievement_criteria_data` (`criteria_id`,`type`,`ScriptName`) VALUES
(@CRITERIA_HOGGER,     11, 'dk_achievement_argent_confessor_hogger'),
(@CRITERIA_VANCLEEF,   11, 'dk_achievement_argent_confessor_vancleef'),
(@CRITERIA_MUTANUS,    11, 'dk_achievement_argent_confessor_mutanus'),
(@CRITERIA_HEROD,      11, 'dk_achievement_argent_confessor_herod'),
(@CRITERIA_LUCIFRON,   11, 'dk_achievement_argent_confessor_lucifron'),
(@CRITERIA_THUNDERAAN, 11, 'dk_achievement_argent_confessor_thunderaan'),
(@CRITERIA_CHROMAGGUS, 11, 'dk_achievement_argent_confessor_chromaggus'),
(@CRITERIA_HAKKAR,     11, 'dk_achievement_argent_confessor_hakkar'),
(@CRITERIA_VEKNILASH,  11, 'dk_achievement_argent_confessor_veknilash'),
(@CRITERIA_KALITHRESH, 11, 'dk_achievement_argent_confessor_kalithresh'),
(@CRITERIA_MALCHEZAAR, 11, 'dk_achievement_argent_confessor_malchezaar'),
(@CRITERIA_GRUUL,      11, 'dk_achievement_argent_confessor_gruul'),
(@CRITERIA_VASHJ,      11, 'dk_achievement_argent_confessor_vashj'),
(@CRITERIA_ARCHIMONDE, 11, 'dk_achievement_argent_confessor_archimonde'),
(@CRITERIA_ILLIDAN,    11, 'dk_achievement_argent_confessor_illidan'),
(@CRITERIA_DELRISSA,   11, 'dk_achievement_argent_confessor_delrissa'),
(@CRITERIA_MURU,       11, 'dk_achievement_argent_confessor_muru'),
(@CRITERIA_INGVAR,     11, 'dk_achievement_argent_confessor_ingvar'),
(@CRITERIA_CYANIGOSA,  11, 'dk_achievement_argent_confessor_cyanigosa'),
(@CRITERIA_ECK,        11, 'dk_achievement_argent_confessor_eck'),
(@CRITERIA_ONYXIA,     11, 'dk_achievement_argent_confessor_onyxia'),
(@CRITERIA_HEIGAN,     11, 'dk_achievement_argent_confessor_heigan'),
(@CRITERIA_IGNIS,      11, 'dk_achievement_argent_confessor_ignis'),
(@CRITERIA_VEZAX,      11, 'dk_achievement_argent_confessor_vezax'),
(@CRITERIA_ALGALON,    11, 'dk_achievement_argent_confessor_algalon');
...
UPDATE `creature_template` SET `ScriptName`='dk_npc_risen_ghoul' WHERE `entry`=@RISEN_CHAMP;
...
INSERT INTO `achievement_criteria_data` (`criteria_id`,`type`,`ScriptName`) VALUES
(11789, 11, 'dk_achievement_ive_had_worse');
