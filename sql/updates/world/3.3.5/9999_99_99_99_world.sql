...
UPDATE `gameobject_template` SET `ScriptName` = 'go_eternal_flame'      WHERE `entry`=148418;
UPDATE `gameobject_template` SET `ScriptName` = 'go_eternal_flame'      WHERE `entry`=148419;
UPDATE `gameobject_template` SET `ScriptName` = 'go_eternal_flame'      WHERE `entry`=148420;
UPDATE `gameobject_template` SET `ScriptName` = 'go_eternal_flame'      WHERE `entry`=148421;

INSERT INTO `spell_script_names` (`spell_id`, `ScriptName`) VALUES (12346, 'spell_sunken_temple_awaken_the_soulflayer');
