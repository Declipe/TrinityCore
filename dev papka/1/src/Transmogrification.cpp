...
void Transmogrification::LoadConfig(bool reload)
{
    ...
    SetNpcText = uint32(sConfigMgr->GetOption<int32>("Transmogrification.SetNpcText", 601084));

    EnableSets = sConfigMgr->GetOption<bool>("Transmogrification.EnableSets", true);
    MaxSets = (uint8)sConfigMgr->GetOption<int32>("Transmogrification.MaxSets", 10);
    ...
    TransmogNpcText = uint32(sConfigMgr->GetOption<int32>("Transmogrification.TransmogNpcText", 601083));
    ...
    TokenEntry = uint32(sConfigMgr->GetOption<int32>("Transmogrification.TokenEntry", 49426));
    TokenAmount = uint32(sConfigMgr->GetOption<int32>("Transmogrification.TokenAmount", 1));
