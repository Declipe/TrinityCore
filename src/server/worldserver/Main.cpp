...
TCHAR serviceLongName[] = _T("Ctulhunet.ru world service");
TCHAR serviceDescription[] = _T("Ctulhunet.ru World of Warcraft emulator world service");
/*
...
void WorldUpdateLoop()
{
    ...
    ZynDatabase.WarnAboutSyncQueries(false);
}
