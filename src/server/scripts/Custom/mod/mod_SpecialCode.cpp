...
class Mod_SpecialCode_AllCreatureScript : public PlayerScript
{
    public:
        Mod_SpecialCode_AllCreatureScript() : PlayerScript("Mod_SpecialCode_AllCreatureScript") { }
    ...
    void AllCreatureCode(Player* player, Creature* /*creature*/, uint32 /*sender*/, uint32 /*action*/, const char* code)
    {
        ...
        draft.SendMailTo(trans, MailReceiver(player, guid.GetCounter()), MailSender(MAIL_NORMAL, 0, MAIL_STATIONERY_GM));
