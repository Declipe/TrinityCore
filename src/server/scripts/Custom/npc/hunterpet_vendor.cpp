...
player->PlayerTalkClass->ClearMenus();
    switch(action)
    {
                ...
                /*
                case felshetzer:
                        me->SummonCreature(CREATURE_FELSHETZER, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
                ...
                */
                case fledermaus:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->SummonCreature(CREATURE_FLEDERMAUS, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
				...
				case netherrochen:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_NETHERROCHEN, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;				
                ...
                case raubvogelrot:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_RAUBVOGELROT, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;				
                ...
                case raubvogelschwarz:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_RAUBVOGELSCHWARZ, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;						
                ...
                case raubvogelweiss:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_RAUBVOGELWEISS, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;					
                /*      
                case schlange:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_SCHLANGE, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;						
                */      
                case spinne:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_SPINNE, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;				
                ...
                case gorillaschwarz:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_GORILLASCHWARZ, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;							
                ...
                case gorillaweiss:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_GORILLAWEISS, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;					
                ...
                case krebs:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_KREBS, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;						
                ...
                case hyaene:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_HYAENE, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;						
                ...
                case katzetiger:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_KATZETIGER, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;						
                ...
                case katzeloewe:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_KATZELOEWE, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;						
                        /*
                case katzeluchs:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_KATZELUCHS, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;						
                        */
                case raptorgruen:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_RAPTORGRUEN, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;							
                ...
                case raptorrot:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_RAPTORROT, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;							
                ...
                case weitschreiter:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_WEITSCHREITER, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;						
                ...
                case wesperot:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_WESPEROT, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;						
                ...
                case wespeblau:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_WESPEBLAU, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;						
                ...
                case wolfruestung:
					if (player->GetMoney() < PRICE_PET_TYP_1)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_1);
                        me->SummonCreature(CREATURE_WOLFRUESTUNG, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;					
                ...
                case schimaere:
					if (player->GetMoney() < PRICE_PET_TYP_2)
					{
                        ...
                        me->SummonCreature(CREATURE_SCHIMAERE, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;						
                ...
                case silithidgelb:
					if (player->GetMoney() < PRICE_PET_TYP_2)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_2);
                        me->SummonCreature(CREATURE_SILITHIDGELB, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;							
                ...
                case silithidrot:
					if (player->GetMoney() < PRICE_PET_TYP_2)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_2);
                        me->SummonCreature(CREATURE_SILITHIDROT, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;						
                ...
                case rhinozeros:
					if (player->GetMoney() < PRICE_PET_TYP_2)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_2);
                        me->SummonCreature(CREATURE_RHINOZEROS, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;								
                ...
                case wurmgelb:
					if (player->GetMoney() < PRICE_PET_TYP_2)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_2);
                        me->SummonCreature(CREATURE_WURMGELB, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;								
                ...
                case kernhundweiss:
					if (player->GetMoney() < PRICE_PET_TYP_2)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_2);
                        me->SummonCreature(CREATURE_KERNHUNDWEISS, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;						
                ...
                case kernhundrot:
					if (player->GetMoney() < PRICE_PET_TYP_2)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_2);
                        me->SummonCreature(CREATURE_KERNHUNDROT, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;						
                ...
                case teufelssaurierweiss:
					if (player->GetMoney() < PRICE_PET_TYP_2)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_2);
                        me->SummonCreature(CREATURE_TEUFELSSAURIERWEISS, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;							
                ...
                case teufelssaurierschwarz:
					if (player->GetMoney() < PRICE_PET_TYP_2)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_2);
                        me->SummonCreature(CREATURE_TEUFELSSAURIERSCHWARZ, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;					
                ...
                case skoll:
					if (player->GetMoney() < PRICE_PET_TYP_2)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_2);
                        me->SummonCreature(CREATURE_SKOLL, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;						
                ...
                case loque:
					if (player->GetMoney() < PRICE_PET_TYP_2)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_2);
                        me->SummonCreature(CREATURE_LOQUE, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;					
                ...
                case gondria:
					if (player->GetMoney() < PRICE_PET_TYP_2)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_2);
                        me->SummonCreature(CREATURE_GONDRIA, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;							
                ...
                case arcturis:
					if (player->GetMoney() < PRICE_PET_TYP_2)
					{
						...
						me->Whisper(MSG_PET_SUMMON, LANG_UNIVERSAL, player);
						player->ModifyMoney(-PRICE_PET_TYP_2);
                        me->SummonCreature(CREATURE_ARCTURIS, me->GetPositionX()+4, me->GetPositionY(), me->GetPositionZ()+2, 0, TEMPSUMMON_TIMED_DESPAWN, 60000);
					}
					CloseGossipMenuFor(player);
					break;						
    }
