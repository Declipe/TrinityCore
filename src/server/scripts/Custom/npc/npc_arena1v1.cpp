...
#define GTS2 session->GetTrinityString2
    ...
    struct npc_1v1arena : public ScriptedAI
    {
        ...
        bool JoinQueueArena(Player* player, Creature* me, bool isRated)
        {
            ...
            [[maybe_unused]] GroupJoinBattlegroundResult err = ERR_GROUP_JOIN_BATTLEGROUND_FAIL;
        ...
        bool OnGossipHello(Player* player) override
        {
            ...
            if (sGameConfig->GetBoolConfig("Arena.1v1.Enable") == false)
            {
        ...
        bool GossipSelect(Player* player, uint32 /*sender*/, uint32 action)
        {
            ...
            case 8: // Script Info
            {
                ...
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "Version: 2.5", GOSSIP_SENDER_MAIN, action);
