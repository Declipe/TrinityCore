    ...
    struct dk_npc_black_knight_skeletal_gryphonAI : public EscortAI
    {
        ...
        void SetData(uint32 uiType, uint32 /*uiData*/) override
        {
            if (uiType == 1)
            {
                ...
                AddWaypoint(0, 766.99f, 657.16f, 457.43f, true);
                AddWaypoint(1, 747.28f, 659.71f, 440.49f, true);
                AddWaypoint(2, 730.03f, 639.59f, 428.16f, true);
                AddWaypoint(3, 721.13f, 621.49f, 423.16f, true);
                AddWaypoint(4, 731.72f, 599.81f, 421.99f, true);
                AddWaypoint(5, 753.71f, 591.09f, 420.63f, true);
                AddWaypoint(6, 776.53f, 597.52f, 418.05f, true);
                AddWaypoint(7, 787.38f, 617.07f, 417.49f, true);
                AddWaypoint(8, 777.06f, 636.98f, 416.57f, true);
                AddWaypoint(9, 760.6f, 642.12f, 414.71f, true);
                AddWaypoint(10, 752.58f, 632.35f, 411.63f, true);
                // The vehicle starts flying away
                AddWaypoint(11, 748.89f, 633.61f, 415.24f, true);
                AddWaypoint(12, 740.42f, 636.31f, 418.32f, true);
                AddWaypoint(13, 727.49f, 637.4f, 422.24f, true);
                AddWaypoint(14, 716.59f, 617.99f, 422.24f, true);
                AddWaypoint(15, 727.18f, 599.29f, 422.24f, true);
                AddWaypoint(16, 746.63f, 587.77f, 422.24f, true);
                AddWaypoint(17, 765.6f, 599.52f, 422.24f, true);
                AddWaypoint(18, 777.01f, 618.79f, 422.24f, true);
                AddWaypoint(19, 761.84f, 642.18f, 422.24f, true);
                AddWaypoint(20, 746.09f, 670.33f, 429.68f, true);
                AddWaypoint(21, 748.02f, 728.22f, 466.68f, true);
                AddWaypoint(22, 779.44f, 797.49f, 477.79f, true);
                AddWaypoint(23, 859.14f, 807.98f, 477.79f, true);
                Start(false);
            }
            else if (uiType == 2)
            {
