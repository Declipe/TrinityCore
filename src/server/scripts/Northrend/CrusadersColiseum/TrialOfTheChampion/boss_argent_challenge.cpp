...
public:
    ...
    struct npc_argent_soldierAI : public ScriptedAI
    {
        ...
        void DamageTaken(Unit* /*attacker*/, uint32& damage, DamageEffectType /*damageType*/, SpellInfo const* /*spellInfo = nullptr*/) override //UNIT_FLAG_UNINTERACTIBLE
        {
        ...
        void JustEngagedWith(Unit* /*who*/) override
        {
            switch (me->GetEntry())
            {
                ...
                case NPC_PRIESTESS:
                    ...
                    _events.ScheduleEvent(EVENT_HOLY_SMITE, 3s);
...
public:
    ...
    class spell_paletress_reflective_shield_AuraScript : public AuraScript
    {
        ...
        void HandleScript(AuraEffect* aurEff, DamageInfo& dmgInfo, uint32& absorbAmount)
        {
            ...
            int32 bp = CalculatePct(absorbAmount, GetSpellInfo()->GetEffect(EFFECT_2).CalcValue());
