...
{
    static_assert(DATA_UPPERSPIRE_TELE_ACT == 42, "icecrown_citadel.h DATA_UPPERSPIRE_TELE_ACT set to value != 42, gossip condition of the teleporters won't work as intended.");
