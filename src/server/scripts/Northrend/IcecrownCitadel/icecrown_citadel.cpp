...
public:
    ...
    struct npc_flesh_eating_insectAI : public ScriptedAI
    {
        ...
        {
            _events.Reset();
            _events.ScheduleEvent(EVENT_FLESH_EATING_BITE, 3s);
        }
        ...
        void DoAction(int32 action) override
        {
            ...
            case ACTION_PUTRICIDE_BUG_LEAP:
                ...
                _events.ScheduleEvent(EVENT_END_LEAP, 2500ms);
                break;
            default:
                break;
            }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = _events.ExecuteEvent())
            {
                ...
                case EVENT_FLESH_EATING_BITE:
                    ...
                    _events.ScheduleEvent(EVENT_FLESH_EATING_BITE, 2500ms);
                    break;
                default:
                    break;
                }
...
public:
    ...
    class spell_icc_summon_plagued_insect_SpellScript : public SpellScript
    {
        ...
        void HandleSummon(SpellEffIndex effIndex)
        {
            ...
            SummonPropertiesEntry const* properties = sSummonPropertiesStore.LookupEntry(uint32(GetEffectInfo(effIndex).MiscValueB));
