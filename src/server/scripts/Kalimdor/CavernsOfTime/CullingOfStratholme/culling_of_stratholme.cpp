...
class npc_chromie_middle : public StratholmeCreatureScript<NullCreatureAI>
{
    public:
        ...
        struct npc_chromie_middleAI : public StratholmeCreatureScript<NullCreatureAI>::GetCullingOfStratholmeAI
        {
            npc_chromie_middleAI(Creature* creature, ProgressStates _respawnMask, ProgressStates _despawnMask) : StratholmeCreatureScript<NullCreatureAI>::GetCullingOfStratholmeAI(creature, _respawnMask, _despawnMask), _whisperDelay(0) { }
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetCullingOfStratholmeAI<npc_chromie_middleAI>(creature, _respawnMask, _despawnMask);
        }
};
...
struct npc_martha_goslin : public CreatureScript
{
    ...
    struct npc_martha_goslinAI : public NullCreatureAI
    {
        ...
        void JustAppeared() override { InitializeAI(); _interruptTimer = 0; _resumeInfo.Clear(); }
...
struct npc_jena_anderson : public CreatureScript
{
    ...
    struct npc_jena_andersonAI : public NullCreatureAI
    {
        ...
        void JustAppeared() override { InitializeAI(); started = false; }
...
class npc_crate_helper : public StratholmeCreatureScript<NullCreatureAI>
{
    ...
    struct npc_crate_helperAI : public StratholmeCreatureScript<NullCreatureAI>::GetCullingOfStratholmeAI
    {
        npc_crate_helperAI(Creature* creature, ProgressStates _respawnMask, ProgressStates _despawnMask) : StratholmeCreatureScript<NullCreatureAI>::GetCullingOfStratholmeAI(creature, _respawnMask, _despawnMask), _crateRevealed(false) { }
    ...
    CreatureAI* GetAI(Creature* creature) const override
    {
        return GetCullingOfStratholmeAI<npc_crate_helperAI>(creature, _respawnMask, _despawnMask);
    }
};
