...
enum TrinityStrings
{
    ...
    // Room for level 0                 = 87-95, not used
    ...
    // Room for level 1                 = 188-199, not used
    ...
    // Room for level 2                 = 365-399, not used
